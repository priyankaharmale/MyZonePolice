...
public class LocationUpdatesService extends Service {
    ...
    public boolean onUnbind(Intent intent) {
        ...
        if (!mChangingConfiguration && Zone4LiveApp.cache.readBoolean(this, Constant.KEY_REQUESTING_LOCATION_UPDATES, false)) {
    ...
    public void requestLocationUpdates() {
        ...
        Zone4LiveApp.cache.writeBoolean(this, Constant.KEY_REQUESTING_LOCATION_UPDATES, true);
        startService(new Intent(getApplicationContext(), LocationUpdatesService.class));
        try {
            mFusedLocationClient.requestLocationUpdates(mLocationRequest,
                    mLocationCallback, Looper.myLooper());
        } catch (SecurityException unlikely) {
            Zone4LiveApp.cache.writeBoolean(this, Constant.KEY_REQUESTING_LOCATION_UPDATES, false);
    ...
    private Notification getNotification() {
        ...
        CharSequence text = IOUtils.getLocationText(mLocation);
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            servicePendingIntent = PendingIntent.getService(this, 0, intent, PendingIntent.FLAG_IMMUTABLE);
        }
        else
        {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.S) {
            activityPendingIntent = PendingIntent.getActivity(this, 0, new Intent(this, MainActivity.class), PendingIntent.FLAG_IMMUTABLE);
        }
        else
        {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.drawable.app_icon, getString(R.string.launch_activity),
                        activityPendingIntent)
                .addAction(R.drawable.ic_close, getString(R.string.remove_location_updates),
                        servicePendingIntent)
                .setContentText(text)
                .setContentTitle(IOUtils.getLocationTitle(this))
                .setOngoing(true)
    ...
    private void SavetoServer(){
        ...
        Log.e("resMM", "Send to server");
        Log.e("resML", String.valueOf(latitude));
        Log.e("resMLL", String.valueOf(longitude));
